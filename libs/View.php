...
class View {
    ...
    public function render ($path) {
        ...
        $ctempPath = __ROOT__ . Config::get("dirs/compiled_templates") . "/" . Str::replace(Config::get("forum/theme/default_theme") . "/" . $path, ["/" => "."]) . ".ctemp.php";
        try {
            if (!file_exists(__ROOT__ . Config::get("dirs/view") . "/" . Config::get("forum/theme/default_theme") . "/" . $path . ".temp.php")) {
