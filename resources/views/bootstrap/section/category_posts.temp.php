                ...
                <tr class="w-100">
                    ...
                    <td style="width: 20%;">
                        @if ($this->postObj->getLastPost($post->id, $this->category->id) !== null):
                            ...
                            <p class="small-grey-text">{{ $this->postObj->dateTimeAlphaMonth($this->postObj->getLastPost($post->id, $this->category->id)->created_at, Libs\Config::get('category/view/last_post/date/short_notation')) }}</p>
                        @else
