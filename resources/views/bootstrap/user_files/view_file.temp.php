    ...
    @if ($this->data !== null):
        ...
        <div class="col border-bottom text-center">
            <div class="media mt-10">
                <img class="img-fluid mx-auto d-block" src="{{ $this->file->isValidImage($this->data->path) ? route('/') . Libs\Config::get('upload_dir') . $this->data->path : route('/') . '/public/app/img/file-ico.png' }}">
            </div>
        ...
        <div class="col">
            ...
            <p class="small-grey-text">File path: <a href="{{ route('/') . Libs\Config::get('upload_dir') . $this->data->path }}"><b>{{ route('/') . Libs\Config::get('upload_dir') . $this->data->path }}</b></a></p>
